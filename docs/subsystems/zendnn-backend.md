<!--
@file: docs/subsystems/zendnn-backend.md
@doc_type: subsystem_reference
@version: 1.0.0
@title: Zendnn Backend
@summary: Overview and setup instructions for the Zendnn Backend.
@tags: [backend, zendnn, subsystem, compute]
